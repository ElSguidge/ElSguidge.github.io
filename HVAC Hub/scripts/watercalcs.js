...
function getTurns() {
  ...
  if (
    list1SelectedValue == "Flange/Groove" &&
    $.inArray(list2SelectedValue, ["20", "25"]) >= 0
  ) {
    ...
    list1SelectedValue == "Flange/Groove" &&
    $.inArray(list2SelectedValue, ["32", "40", "50"]) >= 0
  ) {
    list3.options.length = 0;
    list3.options[0] = new Option("1", "1");
    list3.options[1] = new Option("1.1", "1.1");
    ...
    list3.options[63] = new Option("6.9", "6.9");
    list3.options[64] = new Option("7", "7");
  } else if ($.inArray(list2SelectedValue, ["80", "100", "125", "150"]) >= 0) {
    list3.options.length = 0;
    list3.options[0] = new Option("1", "1");
    list3.options[1] = new Option("1.1", "1.1");
    list3.options[2] = new Option("1.2", "1.2");
    ...
    list3.options[20] = new Option("5", "5");
    list3.options[21] = new Option("5.1", "5.1");
    list3.options[22] = new Option("5.2", "5.2");
    list3.options[23] = new Option("5.3", "5.3");
    list3.options[24] = new Option("5.4", "5.4");
    list3.options[25] = new Option("5.5", "5.5");
    list3.options[26] = new Option("5.6", "5.6");
    list3.options[27] = new Option("5.7", "5.7");
    list3.options[28] = new Option("5.8", "5.8");
    list3.options[29] = new Option("5.9", "5.9");
    list3.options[30] = new Option("6", "6");
    list3.options[31] = new Option("6.1", "6.1");
    list3.options[32] = new Option("6.2", "6.2");
    list3.options[33] = new Option("6.3", "6.3");
    list3.options[34] = new Option("6.4", "6.4");
    list3.options[35] = new Option("6.5", "6.5");
    list3.options[36] = new Option("6.6", "6.6");
    list3.options[37] = new Option("6.7", "6.7");
    list3.options[38] = new Option("6.8", "6.8");
    list3.options[39] = new Option("6.9", "6.9");
    list3.options[40] = new Option("7", "7");
    list3.options[41] = new Option("7.1", "7.1");
    list3.options[42] = new Option("7.2", "7.2");
    list3.options[43] = new Option("7.3", "7.3");
    list3.options[44] = new Option("7.4", "7.4");
    list3.options[45] = new Option("7.5", "7.5");
    list3.options[46] = new Option("7.6", "7.6");
    list3.options[47] = new Option("7.7", "7.7");
    list3.options[48] = new Option("7.8", "7.8");
    list3.options[49] = new Option("7.9", "7.9");
    list3.options[50] = new Option("8", "8");
    list3.options[51] = new Option("8.1", "8.1");
    list3.options[52] = new Option("8.2", "8.2");
    list3.options[53] = new Option("8.3", "8.3");
    list3.options[54] = new Option("8.4", "8.4");
    list3.options[55] = new Option("8.5", "8.5");
    list3.options[56] = new Option("8.6", "8.6");
    list3.options[57] = new Option("8.7", "8.7");
    list3.options[58] = new Option("8.8", "8.8");
    list3.options[59] = new Option("8.9", "8.9");
    list3.options[60] = new Option("9", "9");
    list3.options[61] = new Option("9.1", "9.1");
    list3.options[62] = new Option("9.2", "9.2");
    list3.options[63] = new Option("9.3", "9.3");
    list3.options[64] = new Option("9.4", "9.4");
    list3.options[65] = new Option("9.5", "9.5");
    list3.options[66] = new Option("9.6", "9.6");
    list3.options[67] = new Option("9.7", "9.7");
    list3.options[68] = new Option("9.8", "9.8");
    list3.options[69] = new Option("9.9", "9.9");
    list3.options[70] = new Option("10", "10");
    list3.options[71] = new Option("10.1", "10.1");
    list3.options[72] = new Option("10.2", "10.2");
    list3.options[73] = new Option("10.3", "10.3");
    list3.options[74] = new Option("10.4", "10.4");
    list3.options[75] = new Option("10.5", "10.5");
    list3.options[76] = new Option("10.6", "10.6");
    list3.options[77] = new Option("10.7", "10.7");
    list3.options[78] = new Option("10.8", "10.8");
    list3.options[79] = new Option("10.9", "10.9");
    list3.options[80] = new Option("11", "11");
    list3.options[81] = new Option("11.1", "11.1");
    list3.options[82] = new Option("11.2", "11.2");
    list3.options[83] = new Option("11.3", "11.3");
    list3.options[84] = new Option("11.4", "11.4");
    list3.options[85] = new Option("11.5", "11.5");
    list3.options[86] = new Option("11.6", "11.6");
    list3.options[87] = new Option("11.7", "11.7");
    list3.options[88] = new Option("11.8", "11.8");
    list3.options[89] = new Option("11.9", "11.9");
    list3.options[90] = new Option("12", "12");
    list3.options[91] = new Option("12.1", "12.1");
    list3.options[92] = new Option("12.2", "12.2");
    list3.options[93] = new Option("12.3", "12.3");
    list3.options[94] = new Option("12.4", "12.4");
    list3.options[95] = new Option("12.5", "12.5");
    list3.options[96] = new Option("12.6", "12.6");
    list3.options[97] = new Option("12.7", "12.7");
    list3.options[98] = new Option("12.8", "12.8");
    list3.options[99] = new Option("12.9", "12.9");
    list3.options[100] = new Option("13", "13");
    list3.options[101] = new Option("13.1", "13.1");
    list3.options[102] = new Option("13.2", "13.2");
    list3.options[103] = new Option("13.3", "13.3");
    list3.options[104] = new Option("13.4", "13.4");
    list3.options[105] = new Option("13.5", "13.5");
    list3.options[106] = new Option("13.6", "13.6");
    list3.options[107] = new Option("13.7", "13.7");
    list3.options[108] = new Option("13.8", "13.8");
    list3.options[109] = new Option("13.9", "13.9");
    list3.options[110] = new Option("14", "14");
    list3.options[111] = new Option("14.1", "14.1");
    list3.options[112] = new Option("14.2", "14.2");
    list3.options[113] = new Option("14.3", "14.3");
    list3.options[114] = new Option("14.4", "14.4");
    list3.options[115] = new Option("14.5", "14.5");
    list3.options[116] = new Option("14.6", "14.6");
    list3.options[117] = new Option("14.7", "14.7");
    list3.options[118] = new Option("14.8", "14.8");
    list3.options[119] = new Option("14.9", "14.9");
    list3.options[120] = new Option("15", "15");
    list3.options[121] = new Option("15.1", "15.1");
    list3.options[122] = new Option("15.2", "15.2");
    list3.options[123] = new Option("15.3", "15.3");
    list3.options[124] = new Option("15.4", "15.4");
    list3.options[125] = new Option("15.5", "15.5");
    list3.options[126] = new Option("15.6", "15.6");
    list3.options[127] = new Option("15.7", "15.7");
    list3.options[128] = new Option("15.8", "15.8");
    list3.options[129] = new Option("15.9", "15.9");
    list3.options[130] = new Option("16", "16");
    list3.options[131] = new Option("16.1", "16.1");
    list3.options[132] = new Option("16.2", "16.2");
    list3.options[133] = new Option("16.3", "16.3");
    list3.options[134] = new Option("16.4", "16.4");
    list3.options[135] = new Option("16.5", "16.5");
    list3.options[136] = new Option("16.6", "16.6");
    list3.options[137] = new Option("16.7", "16.7");
    list3.options[138] = new Option("16.8", "16.8");
    list3.options[139] = new Option("16.9", "16.9");
    list3.options[140] = new Option("17", "17");
    list3.options[141] = new Option("17.1", "17.1");
    list3.options[142] = new Option("17.2", "17.2");
    list3.options[143] = new Option("17.3", "17.3");
    list3.options[144] = new Option("17.4", "17.4");
    list3.options[145] = new Option("17.5", "17.5");
    list3.options[146] = new Option("17.6", "17.6");
    list3.options[147] = new Option("17.7", "17.7");
    list3.options[148] = new Option("17.8", "17.8");
    list3.options[149] = new Option("17.9", "17.9");
    list3.options[150] = new Option("18", "18");
    ...
    list3.options[149] = new Option("17.9", "17.9");
    list3.options[150] = new Option("18", "18");
    list3.options[151] = new Option("18.1", "18.1");
    list3.options[152] = new Option("18.2", "18.2");
    list3.options[153] = new Option("18.3", "18.3");
    list3.options[154] = new Option("18.4", "18.4");
    list3.options[155] = new Option("18.5", "18.5");
    list3.options[156] = new Option("18.6", "18.6");
    list3.options[157] = new Option("18.7", "18.7");
    list3.options[158] = new Option("18.8", "18.8");
    list3.options[159] = new Option("18.9", "18.9");
    list3.options[160] = new Option("19", "19");
    list3.options[161] = new Option("19.1", "19.1");
    list3.options[162] = new Option("19.2", "19.2");
    list3.options[163] = new Option("19.3", "19.3");
    list3.options[164] = new Option("19.4", "19.4");
    list3.options[165] = new Option("19.5", "19.5");
    list3.options[166] = new Option("19.6", "19.6");
    list3.options[167] = new Option("19.7", "19.7");
    list3.options[168] = new Option("19.8", "19.8");
    list3.options[169] = new Option("19.9", "19.9");
    list3.options[170] = new Option("20", "20");
    list3.options[171] = new Option("20.1", "20.1");
    list3.options[172] = new Option("20.2", "20.2");
    list3.options[173] = new Option("20.3", "20.3");
    list3.options[174] = new Option("20.4", "20.4");
    list3.options[175] = new Option("20.5", "20.5");
    list3.options[176] = new Option("20.6", "20.6");
    list3.options[177] = new Option("20.7", "20.7");
    list3.options[178] = new Option("20.8", "20.8");
    list3.options[179] = new Option("20.9", "20.9");
    list3.options[180] = new Option("21", "21");
    list3.options[181] = new Option("21.1", "21.1");
    list3.options[182] = new Option("21.2", "21.2");
    list3.options[183] = new Option("21.3", "21.3");
    list3.options[184] = new Option("21.4", "21.4");
    list3.options[185] = new Option("21.5", "21.5");
    list3.options[186] = new Option("21.6", "21.6");
    list3.options[187] = new Option("21.7", "21.7");
    list3.options[188] = new Option("21.8", "21.8");
    list3.options[189] = new Option("21.9", "21.9");
    list3.options[190] = new Option("22", "22");
    list3.options[191] = new Option("22.1", "22.1");
    list3.options[192] = new Option("22.2", "22.2");
    list3.options[193] = new Option("22.3", "22.3");
    list3.options[194] = new Option("22.4", "22.4");
    list3.options[195] = new Option("22.5", "22.5");
    list3.options[196] = new Option("22.6", "22.6");
    list3.options[197] = new Option("22.7", "22.7");
    list3.options[198] = new Option("22.8", "22.8");
    list3.options[199] = new Option("22.9", "22.9");
    list3.options[200] = new Option("23", "23");
    list3.options[201] = new Option("23.1", "23.1");
    list3.options[202] = new Option("23.2", "23.2");
    list3.options[203] = new Option("23.3", "23.3");
    list3.options[204] = new Option("23.4", "23.4");
    list3.options[205] = new Option("23.5", "23.5");
    list3.options[206] = new Option("23.6", "23.6");
    list3.options[207] = new Option("23.7", "23.7");
    list3.options[208] = new Option("23.8", "23.8");
    list3.options[209] = new Option("23.9", "23.9");
    list3.options[210] = new Option("24", "24");
  }
...
function findInArray() {
  ...
  if (valveType === "Thread/Solder") {
    document.getElementById(
      "kvanswer"
    ).innerHTML = `Kv = ${threaded[selectedThread][selectedTurn]}`;
  } else if (valveType === "Flange/Groove") {
    document.getElementById(
      "kvanswer"
    ).innerHTML = `Kv = ${flange[selectedThread][selectedTurn]}`;
  }
}
...
function gpmUs_ConvertCalculate() {
  ...
  var gpmConverted = parseFloat(gpmUs) * 0.063;
